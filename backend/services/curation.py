...
SEED_SONGS_60S_70S = [
    ...
    ("Don McLean", "American Pie"), ("John Denver", "Take Me Home, Country Roads"),
    ...
    ("Badfinger", "Baby Blue"),
    ("Steve Miller Band", "The Joker"), ("The Cars", "Just What I Needed"),
    ("Blondie", "Heart of Glass"), ("Chic", "Le Freak"),
    ("Christopher Cross", "Sailing"), ("Player", "Baby Come Back"),
...
SEED_SONGS_80S = [
    ...
    ("Crowded House", "Don't Dream It's Over"), ("The Smiths", "There Is a Light That Never Goes Out"),
    ("Grover Washington Jr.", "Just the Two of Us"), ("U2", "With Or Without You"),
    ("The Outfield", "Your Love"), ("Cutting Crew", "(I Just) Died In Your Arms"),
    ("Fleetwood Mac", "Everywhere"), ("Billy Idol", "Eyes Without A Face"),
    ("Eddie Money", "Take Me Home Tonight"), ("Men At Work", "Down Under"),
    ("Men At Work", "Who Can It Be Now?"), ("Tears For Fears", "Head Over Heels"),
    ("Journey", "Any Way You Want It"), ("AC/DC", "Back In Black"),
    ("AC/DC", "You Shook Me All Night Long"), ("Michael Jackson", "Smooth Criminal"),
    ("Guns N' Roses", "Welcome To The Jungle"), ("Bon Jovi", "You Give Love A Bad Name"),
    ("Elton John", "I'm Still Standing"), ("Eurythmics", "Here Comes the Rain Again"),
    ("Wham!", "Last Christmas"), ("ABBA", "Lay All Your Love On Me"),
    ("Rick Astley", "Never Gonna Give You Up"), ("Billy Joel", "Uptown Girl"),
    ("Billy Joel", "We Didn't Start the Fire"), ("Culture Club", "Karma Chameleon"),
    ("Europe", "The Final Countdown"), ("Survivor", "Eye of the Tiger"),
    ("Bonnie Tyler", "Total Eclipse of the Heart"), ("U2", "I Still Haven't Found What I'm Looking For"),
    ("Katrina & The Waves", "Walking On Sunshine"), ("The Proclaimers", "I'm Gonna Be (500 Miles)"),
    ("Bryan Adams", "Summer Of '69"), ("Joan Jett & the Blackhearts", "I Love Rock 'N Roll"),
    ("Roxette", "Listen To Your Heart"), ("Lipps Inc.", "Funkytown"),
    ("Queen", "Under Pressure"), ("Queen", "Another One Bites The Dust"),
    ("The Clash", "Should I Stay or Should I Go"), ("Alphaville", "Forever Young"),
    ("Tom Petty", "Free Fallin'"), ("Rick Springfield", "Jessie's Girl"),
    ("Foreigner", "I Want to Know What Love Is"), ("Journey", "Faithfully"),
    ("Toto", "Rosanna"), ("Whitesnake", "Here I Go Again"),
    ("Bon Jovi", "Wanted Dead or Alive"), ("Talking Heads", "Once in a Lifetime"),
    ("Devo", "Whip It"), ("Simple Minds", "Don't You (Forget About Me)"),
    ("Peter Gabriel", "Sledgehammer"), ("Genesis", "Invisible Touch"),
    ("Steve Winwood", "Higher Love"), ("Huey Lewis and the News", "The Power of Love"),
    ("Kool & The Gang", "Celebration"), ("Toni Basil", "Mickey"),
    ("Dexys Midnight Runners", "Come On Eileen"), ("Berlin", "Take My Breath Away"),
    ("Chicago", "You're the Inspiration"), ("Foreigner", "Waiting for a Girl Like You"),
...
SEED_SONGS_90S = [
    ...
    ("Los Del Rio", "Macarena"), ("Ace of Base", "The Sign"),
    ("Cher", "Believe"),
    ...
    ("Deborah Cox", "Nobody's Supposed to Be Here"), ("Enrique Iglesias", "Bailamos"),
    ("Ricky Martin", "Livin' la Vida Loca"), ("Marc Anthony", "I Need to Know"),
]
...
SEED_SONGS_2000S = [
    ...
    ("Coldplay", "Sparks"), ("Hoobastank", "The Reason"),
    ("Dido", "Thank You"), ("Modjo", "Lady (Hear Me Tonight)"),
    ("Outkast", "Ms. Jackson"), ("Iyaz", "Replay"),
    ("Coldplay", "Viva La Vida"), ("Bon Jovi", "It's My Life"),
    ("Smash Mouth", "I'm A Believer"), ("U2", "Beautiful Day"),
    ("Jason Mraz", "I'm Yours"), ("Kanye West", "I Wonder"),
    ("Kanye West", "Flashing Lights"), ("Owl City", "Fireflies"),
    ("Jason Derulo", "Whatcha Say"), ("Maroon 5", "This Love"),
    ("Colbie Caillat", "Bubbly"), ("Rascal Flatts", "Life is a Highway"),
    ...
    ("Sisqo", "Thong Song"), ("Usher", "Confessions Part II"),
    ("Usher", "U Got It Bad"), ("Ashanti", "Foolish"),
    ("Ciara", "1, 2 Step"), ("Ciara", "Goodies"),
    ("Mya", "My Love Is Like... Wo"), ("Good Charlotte", "Lifestyles of the Rich and Famous"),
    ("Simple Plan", "Welcome to My Life"), ("Sum 41", "In Too Deep"),
    ("Yellowcard", "Ocean Avenue"), ("My Chemical Romance", "Welcome to the Black Parade"),
    ("My Chemical Romance", "I'm Not Okay (I Promise)"), ("Paramore", "Misery Business"),
    ("The All-American Rejects", "Move Along"), ("Boys Like Girls", "The Great Escape"),
    ("Jimmy Eat World", "Sweetness"), ("Bon Iver", "Skinny Love"),
    ("Phoenix", "1901"), ("Carrie Underwood", "Before He Cheats"),
    ("Carrie Underwood", "Jesus, Take the Wheel"), ("Manu Chao", "Me Gustas Tu"),
]
...
SEED_SONGS_2010S = [
    ...
    ("Paramore", "Still Into You"), ("Alt-J", "Breezeblocks"),
    ("Grouplove", "Tongue Tied"), ("Lord Huron", "The Night We Met"),
    ("Two Door Cinema Club", "What You Know"), ("The Neighbourhood", "Daddy Issues"),
    ("Wolf Alice", "Don't Delete the Kisses"), ("Glass Animals", "Gooey"),
    ("Chvrches", "The Mother We Share"), ("Miranda Lambert", "The House That Built Me"),
    ("Keith Urban", "Blue Ain't Your Color"), ("Blake Shelton", "God's Country"),
    ("Thomas Rhett", "Die a Happy Man"), ("Dan + Shay", "Speechless"),
    ("Old Dominion", "Break Up with Him"), ("Sam Hunt", "Take Your Time"),
    ("Chris Young", "Aw Naw"), ("Cole Swindell", "Chillin' It"),
    ("Jordan Davis", "Singles You Up"), ("Ozuna", "Taki Taki"),
...
SEED_SONGS_2020S = [
    ...
    ("girl in red", "we fell in love in october"), ("Gigi Perez", "Sailor Song"),
    ("Coyote Theory", "This Side of Paradise"), ("Coldplay", "My Universe"),
    ("Elton John", "Cold Heart (PNAU Remix)"), ("Elton John", "Hold Me Closer"),
    ("The Weeknd", "Cry For Me"), ("Drake", "Laugh Now Cry Later"),
    ("Metro Boomin", "Creepin'"), ("Don Toliver", "No Idea"),
    ("Future", "Life Is Good"), ("Lizzo", "2 Be Loved (Am I Ready)"),
    ("Nicky Youre", "Sunroof"), ("OneRepublic", "I Ain't Worried"),
    ("Post Malone", "I Like You (A Happier Song)"), ("NEIKED", "Better Days"),
    ("Doja Cat", "Get Into It (Yuh)"), ("Lil Nas X", "STAR WALKIN'"),
    ("Nicki Minaj", "Super Freaky Girl"), ("Marshmello", "Leave Before You Love Me"),
    ("Lil Nas X", "THATS WHAT I WANT"), ("Charlie Puth", "Light Switch"),
    ("Megan Thee Stallion", "Sweetest Pie"), ("Charlie Puth", "Left and Right"),
    ("Marshmello", "Numb"), ("The Kid LAROI", "THOUSAND MILES"),
    ("Ed Sheeran", "2step"), ("DVRST", "Close Eyes"),
    ("Tiesto", "Don't Be Shy"), ("Pink Sweat$", "At My Worst"),
    ("Justin Bieber", "Intentions"), ("Lost Frequencies", "Where Are You Now"),
    ("Sleepy Hallow", "2055"), ("Masked Wolf", "Astronaut In The Ocean"),
    ("Blxst", "Chosen"), ("Justin Bieber", "Lonely"),
    ("Post Malone", "One Right Now"), ("Maroon 5", "Beautiful Mistakes"),
    ("Justin Bieber", "Hold On"), ("Doja Cat", "You Right"),
    ("Lil Nas X", "MONTERO (Call Me By Your Name)"), ("Maroon 5", "Lost"),
    ("Shawn Mendes", "When You're Gone"), ("Doja Cat", "Need to Know"),
    ("Sam Smith", "Unholy"), ("Stephen Sanchez", "Until I Found You"),
    ("Elton John", "Cold Heart"), ("ROSÉ", "APT."),
    ("Lady Gaga", "Hold My Hand"), ("yung kai", "blue"),
    ("The Weeknd", "Timeless"), ("The Weeknd", "One Of The Girls"),
    ("The Weeknd", "Save Your Tears (Remix)"), ("The Weeknd", "Dancing In The Flames"),
    ("The Weeknd", "Popular"), ("Swedish House Mafia", "Moth To A Flame"),
    ("The Weeknd", "Sacrifice"), ("The Weeknd", "Out of Time"),
    ("Travis Scott", "FE!N"), ("Future", "Type Shit"),
    ("¥$", "CARNIVAL"), ("Ariana Grande", "we can't be friends (wait for your love)"),
    ("Ariana Grande", "34+35"), ("The Kid LAROI", "NIGHTS LIKE THIS"),
    ("The Kid LAROI", "BABY I'M BACK"), ("Ed Sheeran", "Shivers"),
    ("Ed Sheeran", "Eyes Closed"), ("Taylor Swift", "I Can Do It With a Broken Heart"),
    ("JVKE", "this is what falling in love feels like"), ("Selena Gomez", "People You Know"),
    ("The Chainsmokers", "Takeaway"), ("The Chainsmokers", "Hope"),
    ("David Guetta", "I Don't Wanna Wait"), ("OneRepublic", "Rescue Me"),
    ("OneRepublic", "Nobody"), ("OneRepublic", "Connection"),
    ("SZA", "Saturn"), ("Maroon 5", "Memories"),
    ("Imagine Dragons", "Enemy"), ("Imagine Dragons", "Bones"),
    ("Miley Cyrus", "Prisoner"), ("Dua Lipa", "Dance The Night"),
    ("David Guetta", "I'm Good (Blue)"), ("David Guetta", "Baby Don't Hurt Me"),
    ("Wiz Khalifa", "Hopeless Romantic"), ("¥$", "FIELD TRIP"),
    ("Baby Keem", "16"), ("Lil Mosey", "Blueberry Faygo"),
    ("Post Malone", "Cooped Up"), ("Future", "Young Metro"),
    ("Artemas", "cross my heart"), ("Gunna", "fukumean"),
    ("Drake", "What's Next"), ("Metro Boomin", "Too Many Nights"),
    ("Drake", "NOKIA"), ("Pop Smoke", "Mood Swings"),
    ("Lil Baby", "Life Goes On"), ("Future", "Cinderella"),
    ("Aaron Smith", "Dancin"), ("Lil Baby", "Stuff"),
    ("Young Thug", "Hot"), ("Internet Money", "Lemonade"),
    ("Masego", "Mystery Lady"), ("Young Thug", "Bad Bad Bad"),
    ("A$AP Rocky", "Everyday"), ("Lil Tecca", "Ransom"),
    ("Mustard", "Ballin'"), ("Metro Boomin", "Superhero (Heroes & Villains)"),
    ("Tommy Richman", "MILLION DOLLAR BABY"), ("Billie Eilish", "everything i wanted"),
    ("d4vd", "Feel It"), ("GIVEON", "Heartbreak Anniversary"),
    ("Lil Uzi Vert", "The Way Life Goes"), ("The Walters", "I Love You So"),
    ("Ravyn Lenae", "Love Me Not"), ("Dhruv", "double take"),
    ("Powfu", "death bed (coffee for your head)"), ("Future", "WAIT FOR U"),
    ("Future", "Solo"), ("The Weeknd", "After Hours"),
    ("THE ANXIETY", "Meet Me At Our Spot"), ("Twenty One Pilots", "Chlorine"),
    ("Lola Marsh", "Something Stupid"),
    ("Anitta", "Envolver"), ("BLACKPINK", "Pink Venom"),
    ("BLACKPINK", "How You Like That"), ("Stray Kids", "God's Menu"),
